...
// Server-side load for the Datenschutz page (spec §16.4, ADR-0010, tasks 31-32).
//
// Resolves the operator-mounted Markdown file for (page=datenschutz, locale) and
...
//   ${LEGAL_DIR}/datenschutz.${locale}.md
//
...
const PAGE = "datenschutz" as const;
